...
"""autogenerated by genpy from custom_msgs/SmoothPathRequest.msg. Do not edit."""
import codecs
import sys
...
class SmoothPathRequest(genpy.Message):
  ...
  _type = "custom_msgs/SmoothPathRequest"
...
def _get_struct_4d():
    ...
    return _struct_4d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from custom_msgs/SmoothPathResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class SmoothPathResponse(genpy.Message):
  _md5sum = "0964cb2ce291cfbc90eb48b9d7f07536"
  _type = "custom_msgs/SmoothPathResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """nav_msgs/Path smooth_path
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.smooth_path is None:
        self.smooth_path = nav_msgs.msg.Path()
    else:
      self.smooth_path = nav_msgs.msg.Path()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3I().pack(_x.smooth_path.header.seq, _x.smooth_path.header.stamp.secs, _x.smooth_path.header.stamp.nsecs))
      _x = self.smooth_path.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.smooth_path.poses)
      buff.write(_struct_I.pack(length))
      for val1 in self.smooth_path.poses:
        _v21 = val1.header
        _x = _v21.seq
        buff.write(_get_struct_I().pack(_x))
        _v22 = _v21.stamp
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.smooth_path.header.seq, _x.smooth_path.header.stamp.secs, _x.smooth_path.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.smooth_path.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.smooth_path.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.smooth_path.poses = []
      for i in range(0, length):
        val1 = geometry_msgs.msg.PoseStamped()
        _v26 = val1.header
        start = end
        ...
        (_x.x, _x.y, _x.z, _x.w,) = _get_struct_4d().unpack(str[start:end])
        self.smooth_path.poses.append(val1)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
...
class SmoothPath(object):
  _type          = 'custom_msgs/SmoothPath'
  _md5sum = '1289371252c92dded0a65b38c8275c64'
