...
(cl:defmethod cl:initialize-instance :after ((m <Edges>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Edges)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name navig_msgs-msg:<Edges> is deprecated: use navig_msgs-msg:Edges instead.")))

(cl:ensure-generic-function 'node_ids-val :lambda-list '(m))
(cl:defmethod node_ids-val ((m <Edges>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader navig_msgs-msg:node_ids-val is deprecated.  Use navig_msgs-msg:node_ids instead.")
  (node_ids m))

(cl:ensure-generic-function 'weights-val :lambda-list '(m))
(cl:defmethod weights-val ((m <Edges>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader navig_msgs-msg:weights-val is deprecated.  Use navig_msgs-msg:weights instead.")
  (weights m))
