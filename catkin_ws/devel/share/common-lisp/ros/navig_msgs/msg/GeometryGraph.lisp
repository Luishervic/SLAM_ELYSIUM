...
(cl:defclass <GeometryGraph> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (edges
    :reader edges
    :initarg :edges
    :type (cl:vector navig_msgs-msg:Edges)
   :initform (cl:make-array 0 :element-type 'navig_msgs-msg:Edges :initial-element (cl:make-instance 'navig_msgs-msg:Edges))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <GeometryGraph>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GeometryGraph)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name navig_msgs-msg:<GeometryGraph> is deprecated: use navig_msgs-msg:GeometryGraph instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <GeometryGraph>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader navig_msgs-msg:header-val is deprecated.  Use navig_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'nodes-val :lambda-list '(m))
(cl:defmethod nodes-val ((m <GeometryGraph>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader navig_msgs-msg:nodes-val is deprecated.  Use navig_msgs-msg:nodes instead.")
  (nodes m))

(cl:ensure-generic-function 'edges-val :lambda-list '(m))
(cl:defmethod edges-val ((m <GeometryGraph>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader navig_msgs-msg:edges-val is deprecated.  Use navig_msgs-msg:edges instead.")
  (edges m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GeometryGraph>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'edges)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'navig_msgs-msg:Edges))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
