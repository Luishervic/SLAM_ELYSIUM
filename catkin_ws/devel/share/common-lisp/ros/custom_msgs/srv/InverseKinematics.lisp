...
(cl:defmethod cl:initialize-instance :after ((m <InverseKinematics-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'InverseKinematics-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_msgs-srv:<InverseKinematics-request> is deprecated: use custom_msgs-srv:InverseKinematics-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <InverseKinematics-request>))
...
(cl:defmethod y-val ((m <InverseKinematics-request>))
...
(cl:defmethod z-val ((m <InverseKinematics-request>))
...
(cl:defmethod roll-val ((m <InverseKinematics-request>))
...
(cl:defmethod pitch-val ((m <InverseKinematics-request>))
...
(cl:defmethod yaw-val ((m <InverseKinematics-request>))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<InverseKinematics-request>)))
  ...
  "custom_msgs/InverseKinematicsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'InverseKinematics-request)))
  "Returns string type for a service object of type 'InverseKinematics-request"
  "custom_msgs/InverseKinematicsRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <InverseKinematics-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'InverseKinematics-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_msgs-srv:<InverseKinematics-response> is deprecated: use custom_msgs-srv:InverseKinematics-response instead.")))

(cl:ensure-generic-function 'q1-val :lambda-list '(m))
(cl:defmethod q1-val ((m <InverseKinematics-response>))
...
(cl:defmethod q2-val ((m <InverseKinematics-response>))
...
(cl:defmethod q3-val ((m <InverseKinematics-response>))
...
(cl:defmethod q4-val ((m <InverseKinematics-response>))
...
(cl:defmethod q5-val ((m <InverseKinematics-response>))
...
(cl:defmethod q6-val ((m <InverseKinematics-response>))
...
(cl:defmethod q7-val ((m <InverseKinematics-response>))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<InverseKinematics-response>)))
  ...
  "custom_msgs/InverseKinematicsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'InverseKinematics-response)))
  "Returns string type for a service object of type 'InverseKinematics-response"
  "custom_msgs/InverseKinematicsResponse")
