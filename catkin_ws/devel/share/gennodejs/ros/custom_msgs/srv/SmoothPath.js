...
class SmoothPathResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.smooth_path = null;
    }
    else {
      if (initObj.hasOwnProperty('smooth_path')) {
        this.smooth_path = initObj.smooth_path
      }
      else {
        this.smooth_path = new nav_msgs.msg.Path();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [smooth_path]
    bufferOffset = nav_msgs.msg.Path.serialize(obj.smooth_path, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [smooth_path]
    data.smooth_path = nav_msgs.msg.Path.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += nav_msgs.msg.Path.getMessageSize(object.smooth_path);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.smooth_path !== undefined) {
      resolved.smooth_path = nav_msgs.msg.Path.Resolve(msg.smooth_path)
    }
    else {
      resolved.smooth_path = new nav_msgs.msg.Path()
    }
...
module.exports = {
  ...
  md5sum() { return '1289371252c92dded0a65b38c8275c64'; },
  datatype() { return 'custom_msgs/SmoothPath'; }
};
