...
class ForwardKinematicsRequest {
  ...
  static datatype() {
    ...
    return 'custom_msgs/ForwardKinematicsRequest';
  }
...
class ForwardKinematicsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'custom_msgs/ForwardKinematicsResponse';
  }
...
module.exports = {
  ...
  md5sum() { return 'a401f28a715e8b3da782b8e7a5889085'; },
  datatype() { return 'custom_msgs/ForwardKinematics'; }
};
